...
const time = [2000,2000,2000,2000,2000,2200,2000,2000,2000,5000,5000,5000,5,5,5,3,5,5,5,5,5,5,5]
const color = ['blue', 'green', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'orange']
